                ...
                foreach($files as $cate) {
                    if($cate!=".htaccess" AND $cate!="." AND $cate!=".." AND $cate!="index.php" AND $cate!="box.php" AND $cate!="mobile.php"){
                        ...
                        if ($filecount>0){
                            ...
                            //title=\"".$catee."\" 
                            echo "<a  data-fancybox data-type=\"iframe\" href=\"/mobilebox.php?lang=".$langdir."&category=".$cate." \"target=\"_new\"><div class=\"floating-box\" ><img class=\"expand\" src=\"/images/".$cate.".png\" /><span class=\"circle-count\">".$filecount." <font size=1>topics</font></span></div></a>";
                        }
                    }
                }
                ?>
